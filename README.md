...
To add new publications, add a new bib entry to `papers.bib`, and run `pandoc papers.bib -t csljson -o data/papers.json`. The `papers.json` file is automatically parsed by `layouts/shortcodes/publications.html`.
