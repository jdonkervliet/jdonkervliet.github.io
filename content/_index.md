...
I am a senior software engineer at [Ubicloud](https://www.ubicloud.com/) where I work on open-source AI and cloud services.

Before I joined Ubicloud, I was a PhD student in the [@Large Research Group](https://atlarge-research.com/) and teacher at the [Vrije Universiteit (VU) Amsterdam](https://vu.nl/nl).

My research focused on creating large-scale modifiable virtual environments (e.g., Minecraft and Roblox).
...
As a teacher at VU, my main responsibilities were teaching the Computer Networks course, and supervising students for their bachelor's and master's theses. I also taught in the Distributed Systems course in the Computer Science master program.
